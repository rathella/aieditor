  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        gold: "bg-gold-500 text-primary-900 shadow-sm hover:bg-gold-400 active:bg-gold-600",
        outline:
          "border border-input bg-card text-primary-800 shadow-sm hover:bg-secondary hover:border-primary-200",
        secondary: "bg-secondary text-primary-800 hover:bg-primary-100",
        ghost: "text-primary-700 hover:bg-secondary",
